...
# Form implementation generated from reading ui file 'C:\repos\spinetoolbox\bin\..\spinetoolbox\data_store_form\ui\data_store_window.ui',
# licensing of 'C:\repos\spinetoolbox\bin\..\spinetoolbox\data_store_form\ui\data_store_window.ui' applies.
#
# Created: Fri Jun 12 13:28:42 2020
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeView_alternative.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.treeView_alternative.setEditTriggers(QtWidgets.QAbstractItemView.EditKeyPressed)
        self.treeView_alternative.setDragDropMode(QtWidgets.QAbstractItemView.InternalMove)
        ...
        self.treeView_object.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        ...
        self.actionEdit_selected = QtWidgets.QAction(MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeView_alternative.setAccessibleName(QtWidgets.QApplication.translate("MainWindow", "alternative tree", None, -1))
        ...
        self.actionEdit_selected.setText(QtWidgets.QApplication.translate("MainWindow", "Edit selected items", None, -1))
        self.actionManage_parameter_tags.setText(QtWidgets.QApplication.translate("MainWindow", "Manage parameter tags", None, -1))
        self.actionRemove_selected.setText(QtWidgets.QApplication.translate("MainWindow", "Remove selected items", None, -1))
        self.actionRemove_selected.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+Del", None, -1))
...
from spinetoolbox.data_store_form.widgets.custom_qtreeview import RelationshipTreeView, ObjectTreeView, ParameterValueListTreeView, AlternativeScenarioTreeView
from spinetoolbox.data_store_form.widgets.custom_qtableview import ObjectParameterDefinitionTableView, ObjectParameterValueTableView, RelationshipParameterDefinitionTableView, FrozenTableView, RelationshipParameterValueTableView, PivotTableView
