...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon18 = QIcon()
        icon18.addFile(u":/icons/menu_icons/map-signs-plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAdd_alternatives.setIcon(icon18)
        self.actionAdd_scenarios = QAction(MainWindow)
        self.actionAdd_scenarios.setObjectName(u"actionAdd_scenarios")
        icon19 = QIcon()
        icon19.addFile(u":/icons/menu_icons/film-plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAdd_scenarios.setIcon(icon19)
        ...
        self.actionAdd_scenario_alternatives.setIcon(icon19)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionAdd_scenario_alternatives.setText(QCoreApplication.translate("MainWindow", u"Add alternatives to scenarios", None))
