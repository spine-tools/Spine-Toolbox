...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionAdd_alternatives = QAction(MainWindow)
        self.actionAdd_alternatives.setObjectName(u"actionAdd_alternatives")
        icon17 = QIcon()
        icon17.addFile(u":/icons/menu_icons/map-signs-plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAdd_alternatives.setIcon(icon17)
        self.actionAdd_scenarios = QAction(MainWindow)
        self.actionAdd_scenarios.setObjectName(u"actionAdd_scenarios")
        icon18 = QIcon()
        icon18.addFile(u":/icons/menu_icons/film-plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAdd_scenarios.setIcon(icon18)
        self.actionAdd_scenario_alternatives = QAction(MainWindow)
        self.actionAdd_scenario_alternatives.setObjectName(u"actionAdd_scenario_alternatives")
        self.actionAdd_scenario_alternatives.setIcon(icon18)
        ...
        self.treeView_alternative.setAcceptDrops(True)
        self.treeView_alternative.setEditTriggers(QAbstractItemView.EditKeyPressed)
        self.treeView_alternative.setDragEnabled(True)
        ...
        self.menuEdit.addSeparator()
        self.menuEdit.addAction(self.actionAdd_alternatives)
        self.menuEdit.addAction(self.actionAdd_scenarios)
        self.menuEdit.addAction(self.actionAdd_scenario_alternatives)
        self.menuEdit.addSeparator()
...
#endif // QT_CONFIG(shortcut)
        self.actionAdd_alternatives.setText(QCoreApplication.translate("MainWindow", u"Add alternatives", None))
        self.actionAdd_scenarios.setText(QCoreApplication.translate("MainWindow", u"Add scenarios", None))
        self.actionAdd_scenario_alternatives.setText(QCoreApplication.translate("MainWindow", u"Add alternatives to scenario", None))
