...
class AddProjectItemWidget(QWidget):
    ...
    Attributes:
        ...
        item_category (str): Category of the new item
        item_type (str): Type of the new item
        x (int): X coordinate of new item
        y (int): Y coordinate of new item
    """

    def __init__(self, toolbox, item_category, item_type, x, y):
        """Initialize class."""
        super().__init__(parent=toolbox, f=Qt.Window)  # Setting parent inherits stylesheet
        self._toolbox = toolbox
        self._category = item_category
        ...
        self.setWindowTitle(f"Add {self._type}")
    ...
    def call_add_item(self):
        ...
        self._project.add_project_items(self._category, item, set_selected=True)
