...
from PySide2.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QListView, QLineEdit, \
    QDialogButtonBox, QMenu, QAction, QTableView, QStyle, QPushButton, \
    QToolBar, QStyleOptionMenuItem, QApplication
...
class AutoFilterWidget(QWidget):
    ...
    def set_values(self, values):
        ...
        width = self.view.horizontalHeader().length() + QApplication.style().pixelMetric(QStyle.PM_ScrollBarExtent)
