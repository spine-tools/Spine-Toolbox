...
class ExcelConnector(FileImportTemplate):
    ...
    def request_data(self, table, max_rows=-1):
        options = {
            "header": self._option_widget.first_row_as_header,
...
class ExcelOptionWidget(QWidget):
    ...
    def get_options_dict(self):
        return {
            "header": self.first_row_as_header,
            "row": self.skip_rows,
            "column": self.skip_columns,
            "read_until_col": self.read_until_col,
            "read_until_row": self.read_until_row,
        }
