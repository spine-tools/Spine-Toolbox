...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_name.setStyleSheet("background-color: rgb(0,162, 232);\n"
"color: rgb(255, 255, 255);")
        ...
        self.label_name_2.setMinimumSize(QtCore.QSize(0, 18))
        self.label_name_2.setMaximumSize(QtCore.QSize(16777215, 18))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        font.setBold(True)
        self.label_name_2.setFont(font)
        self.label_name_2.setStyleSheet("background-color: rgb(0,162, 232);\n"
"color: rgb(255, 255, 255);")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_name_3.sizePolicy().hasHeightForWidth())
        self.label_name_3.setSizePolicy(sizePolicy)
        self.label_name_3.setMinimumSize(QtCore.QSize(0, 12))
        self.label_name_3.setMaximumSize(QtCore.QSize(16777215, 18))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setWeight(75)
        font.setBold(True)
        self.label_name_3.setFont(font)
        self.label_name_3.setStyleSheet("background-color: rgb(0,162, 232);\n"
"color: rgb(255, 255, 255);")
        self.label_name_3.setText("")
        self.label_name_3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_name_3.setWordWrap(True)
    ...
    def retranslateUi(self, Form):
        ...
        self.toolButton_add.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>Add references to project. Import data into Spine data model.</p></body></html>", None, -1))
