...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockWidget_parameters = QtWidgets.QDockWidget(MainWindow)
        self.dockWidget_parameters.setObjectName("dockWidget_parameters")
        self.dockWidgetContents_parameters = QtWidgets.QWidget()
        self.dockWidgetContents_parameters.setObjectName("dockWidgetContents_parameters")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.dockWidgetContents_parameters)
        self.verticalLayout_8.setSpacing(0)
        self.verticalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.dockWidget_parameters.setWidget(self.dockWidgetContents_parameters)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(8), self.dockWidget_parameters)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dockWidget_parameters.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Parameters", None, -1))
