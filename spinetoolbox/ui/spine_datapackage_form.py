...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_datapackage = QtWidgets.QLabel(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_datapackage.sizePolicy().hasHeightForWidth())
        self.label_datapackage.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setWeight(75)
        font.setBold(True)
        self.label_datapackage.setFont(font)
        self.label_datapackage.setObjectName("label_datapackage")
        self.verticalLayout.addWidget(self.label_datapackage)
        self.treeView_datapackage = QtWidgets.QTreeView(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.treeView_datapackage.sizePolicy().hasHeightForWidth())
        self.treeView_datapackage.setSizePolicy(sizePolicy)
        self.treeView_datapackage.setMinimumSize(QtCore.QSize(0, 0))
        self.treeView_datapackage.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.treeView_datapackage.setObjectName("treeView_datapackage")
        self.verticalLayout.addWidget(self.treeView_datapackage)
        self.layoutWidget_2 = QtWidgets.QWidget(self.splitter)
        self.layoutWidget_2.setObjectName("layoutWidget_2")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.layoutWidget_2)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.label_resource_data = QtWidgets.QLabel(self.layoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        ...
        self.verticalLayout_2.addWidget(self.label_resource_data)
        self.tableView_resource_data = QtWidgets.QTableView(self.layoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(2)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_datapackage.setText(QtWidgets.QApplication.translate("MainWindow", "Datapackage", None, -1))
        self.label_resource_data.setText(QtWidgets.QApplication.translate("MainWindow", "Resource data", None, -1))
        self.menuFile.setTitle(QtWidgets.QApplication.translate("MainWindow", "File", None, -1))
        self.actionSave_datapackage.setText(QtWidgets.QApplication.translate("MainWindow", "Save datapackage", None, -1))
        self.actionSave_datapackage.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+S", None, -1))
        self.actionConvert.setText(QtWidgets.QApplication.translate("MainWindow", "Convert to Spine", None, -1))
        ...
        self.actionInfer_datapackage.setText(QtWidgets.QApplication.translate("MainWindow", "Infer new datapackage", None, -1))
        ...
        self.actionLoad_datapackage.setText(QtWidgets.QApplication.translate("MainWindow", "Load existing datapackage", None, -1))
