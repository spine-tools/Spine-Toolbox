...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeView_resources = QtWidgets.QTreeView(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.treeView_resources.sizePolicy().hasHeightForWidth())
        self.treeView_resources.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout.addWidget(self.treeView_resources)
