...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableView_resource_data = CustomQTableView(self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        ...
        self.actionPrimary_keys = QtWidgets.QAction(MainWindow)
        self.actionPrimary_keys.setObjectName("actionPrimary_keys")
        self.actionForeign_keys = QtWidgets.QAction(MainWindow)
        self.actionForeign_keys.setObjectName("actionForeign_keys")
        self.menuFile.addAction(self.actionSave_datapackage)
        self.menuFile.addAction(self.actionExport)
        self.menuFile.addAction(self.actionQuit)
        self.menuEdit.addAction(self.actionPrimary_keys)
        self.menuEdit.addAction(self.actionForeign_keys)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionPrimary_keys.setText(QtWidgets.QApplication.translate("MainWindow", "Primary keys...", None, -1))
        self.actionPrimary_keys.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+P", None, -1))
        self.actionForeign_keys.setText(QtWidgets.QApplication.translate("MainWindow", "Foreign keys...", None, -1))
        self.actionForeign_keys.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+F", None, -1))
