...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitter_2 = QtWidgets.QSplitter(self.tab_object_parameter_value)
        ...
        self.tableView_object_parameter_json = AutoFilterCopyPasteTableView(self.splitter_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.splitter_3 = QtWidgets.QSplitter(self.tab_relationship_parameter_value)
        self.splitter_3.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.tableView_relationship_parameter_json = AutoFilterCopyPasteTableView(self.splitter_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tableView_relationship_parameter_json.sizePolicy().hasHeightForWidth())
        self.tableView_relationship_parameter_json.setSizePolicy(sizePolicy)
        self.tableView_relationship_parameter_json.setObjectName("tableView_relationship_parameter_json")
        self.tableView_relationship_parameter_json.horizontalHeader().setStretchLastSection(False)
