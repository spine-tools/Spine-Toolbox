...
class Ui_SettingsForm(object):
    def setupUi(self, SettingsForm):
        ...
        SettingsForm.setWindowModality(Qt.WindowModality.ApplicationModal)
        SettingsForm.resize(783, 800)
        ...
        SettingsForm.setMinimumSize(QSize(700, 800))
        ...
        SettingsForm.setContextMenuPolicy(Qt.ContextMenuPolicy.NoContextMenu)
        ...
        self.open_work_dir_button = QPushButton(self.groupBox_general)
        self.open_work_dir_button.setObjectName(u"open_work_dir_button")

        self.horizontalLayout_3.addWidget(self.open_work_dir_button)

        self.work_dir_info_label = QLabel(self.groupBox_general)
        self.work_dir_info_label.setObjectName(u"work_dir_info_label")

        self.horizontalLayout_3.addWidget(self.work_dir_info_label)

        self.work_dir_cleanup_button = QPushButton(self.groupBox_general)
        self.work_dir_cleanup_button.setObjectName(u"work_dir_cleanup_button")

        self.horizontalLayout_3.addWidget(self.work_dir_cleanup_button)
        ...
        sizePolicy4.setHeightForWidth(self.pushButton_make_julia_kernel.sizePolicy().hasHeightForWidth())
        self.pushButton_make_julia_kernel.setSizePolicy(sizePolicy4)
        ...
        self.verticalLayout_15.addWidget(self.comboBox_julia_kernel)
        ...
        sizePolicy4.setHeightForWidth(self.pushButton_make_python_kernel.sizePolicy().hasHeightForWidth())
        self.pushButton_make_python_kernel.setSizePolicy(sizePolicy4)
        ...
        self.comboBox_python_kernel.setContextMenuPolicy(Qt.ContextMenuPolicy.CustomContextMenu)

        self.verticalLayout_5.addWidget(self.comboBox_python_kernel)
        ...
        QWidget.setTabOrder(self.toolButton_browse_julia_project, self.pushButton_make_julia_kernel)
        QWidget.setTabOrder(self.pushButton_make_julia_kernel, self.comboBox_julia_kernel)
        QWidget.setTabOrder(self.comboBox_julia_kernel, self.pushButton_install_julia)
        ...
        QWidget.setTabOrder(self.toolButton_browse_python, self.pushButton_make_python_kernel)
        QWidget.setTabOrder(self.pushButton_make_python_kernel, self.comboBox_python_kernel)
        QWidget.setTabOrder(self.comboBox_python_kernel, self.lineEdit_conda_path)
        ...
        QWidget.setTabOrder(self.checkBox_hide_empty_classes, self.checkBox_auto_expand_entities)
        QWidget.setTabOrder(self.checkBox_auto_expand_entities, self.checkBox_merge_dbs)
        QWidget.setTabOrder(self.checkBox_merge_dbs, self.checkBox_snap_entities)
        QWidget.setTabOrder(self.checkBox_snap_entities, self.checkBox_smooth_entity_graph_zoom)
        QWidget.setTabOrder(self.checkBox_smooth_entity_graph_zoom, self.checkBox_smooth_entity_graph_rotation)
        QWidget.setTabOrder(self.checkBox_smooth_entity_graph_rotation, self.spinBox_max_ent_dim_count)
        QWidget.setTabOrder(self.spinBox_max_ent_dim_count, self.spinBox_layout_algo_max_iterations)
        QWidget.setTabOrder(self.spinBox_layout_algo_max_iterations, self.spinBox_layout_algo_spread_factor)
        QWidget.setTabOrder(self.spinBox_layout_algo_spread_factor, self.spinBox_layout_algo_neg_weight_exp)
        QWidget.setTabOrder(self.spinBox_layout_algo_neg_weight_exp, self.checkBox_save_spec_before_closing)
    ...
    def retranslateUi(self, SettingsForm):
        ...
        self.open_work_dir_button.setText(QCoreApplication.translate("SettingsForm", u"Open work directory...", None))
        self.work_dir_info_label.setText(QCoreApplication.translate("SettingsForm", u"Calculating directory size...", None))
        self.work_dir_cleanup_button.setText(QCoreApplication.translate("SettingsForm", u"Delete files...", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.lineEdit_julia_project_path.setToolTip(QCoreApplication.translate("SettingsForm", u"<html><head/><body><p>Julia environment/project directory for Julia Tool specifications. Leave blank to use the default environment.</p><p><span style=\" font-weight:600;\">NOTE:</span> This is the <span style=\" font-weight:700;\">global setting</span> for Julia Tool specs. You can override this for each Tool spec separately.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.pushButton_make_julia_kernel.setToolTip(QCoreApplication.translate("SettingsForm", u"<html><head/><body><p>Makes a Julia kernel for the Julia executable and the Julia project (environment) selected above. If a matching Julia kernel already exists, it is selected.</p><p>You can also create Julia kernels manually using the <span style=\" font-weight:700;\">IJulia</span> package.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.pushButton_make_python_kernel.setToolTip(QCoreApplication.translate("SettingsForm", u"<html><head/><body><p>Makes a Python kernel for the Python interpreter selected above. If a matching Python kernel already exists, it is selected.</p><p>You can also create Python kernels manually using the <span style=\" font-weight:700;\">ipykernel</span> package.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_make_python_kernel.setText(QCoreApplication.translate("SettingsForm", u"Make Python Kernel", None))
#if QT_CONFIG(tooltip)
        self.comboBox_python_kernel.setToolTip(QCoreApplication.translate("SettingsForm", u"<html><head/><body><p>Select a Python kernel spec for Jupyter Console.</p><p><span style=\" font-weight:600;\">NOTE:</span> This is the <span style=\" font-weight:600;\">global setting</span> for Python Tool specs. You can override this for each Tool spec separately.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
