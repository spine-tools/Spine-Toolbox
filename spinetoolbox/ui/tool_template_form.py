...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setTabOrder(self.lineEdit_args, self.toolButton_add_source_files)
        ...
        Form.setTabOrder(self.toolButton_minus_source_files, self.toolButton_plus_inputfiles)
