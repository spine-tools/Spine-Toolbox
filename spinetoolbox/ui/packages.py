...
class Ui_PackagesForm(object):
    def setupUi(self, PackagesForm):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 627, 258))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.groupBox_general = QtWidgets.QGroupBox(self.scrollAreaWidgetContents)
        self.groupBox_general.setGeometry(QtCore.QRect(10, 0, 601, 200))
        ...
        self.pushButton_spine_model_install = QtWidgets.QPushButton(self.groupBox_general)
        self.pushButton_spine_model_install.setMaximumSize(QtCore.QSize(16777215, 23))
        self.pushButton_spine_model_install.setObjectName("pushButton_spine_model_install")
        self.horizontalLayout_2.addWidget(self.pushButton_spine_model_install)
    ...
    def retranslateUi(self, PackagesForm):
        ...
        self.pushButton_spine_model_install.setText(QtWidgets.QApplication.translate("PackagesForm", "Install", None, -1))
