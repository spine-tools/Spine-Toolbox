...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMinimumSize(QtCore.QSize(166, 272))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listView_input_files.sizePolicy().hasHeightForWidth())
        self.listView_input_files.setSizePolicy(sizePolicy)
        ...
        self.listView_output_files = QtWidgets.QListView(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listView_output_files.sizePolicy().hasHeightForWidth())
        self.listView_output_files.setSizePolicy(sizePolicy)
        self.listView_output_files.setObjectName("listView_output_files")
        self.verticalLayout.addWidget(self.listView_output_files)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QtWidgets.QApplication.translate("Form", "Required input files", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("Form", "Output files", None, -1))
