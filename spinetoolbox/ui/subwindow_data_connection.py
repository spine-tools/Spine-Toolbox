...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.toolButton_datapackage.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>Open form to convert from datapackage to Spine.</p></body></html>", None, -1))
