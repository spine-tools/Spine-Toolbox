...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mdiArea_with_links = QtWidgets.QMdiArea(self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.mdiArea_with_links.sizePolicy().hasHeightForWidth())
        self.mdiArea_with_links.setSizePolicy(sizePolicy)
        self.mdiArea_with_links.setObjectName("mdiArea_with_links")
