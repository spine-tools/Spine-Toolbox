...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_remove_all = QtWidgets.QPushButton(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_remove_all.sizePolicy().hasHeightForWidth())
        self.pushButton_remove_all.setSizePolicy(sizePolicy)
        self.pushButton_remove_all.setMaximumSize(QtCore.QSize(100, 16777215))
        self.pushButton_remove_all.setObjectName("pushButton_remove_all")
        self.verticalLayout_5.addWidget(self.pushButton_remove_all)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_remove_all.setText(QtWidgets.QApplication.translate("MainWindow", "Remove All", None, -1))
