...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionPasteAndDuplicateFiles.setText(QCoreApplication.translate("MainWindow", u"Paste project Item and duplicate files", None))
#if QT_CONFIG(tooltip)
        self.actionPasteAndDuplicateFiles.setToolTip(QCoreApplication.translate("MainWindow", u"Paste project item and duplicate files", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionPasteAndDuplicateFiles.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+V", None))
#endif // QT_CONFIG(shortcut)
        self.actionDuplicateAndDuplicateFiles.setText(QCoreApplication.translate("MainWindow", u"Duplicate project item and duplicate files", None))
#if QT_CONFIG(shortcut)
