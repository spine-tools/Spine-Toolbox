...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_add_tool_candidate = QtWidgets.QPushButton(self.tab_tools)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_add_tool_candidate.sizePolicy().hasHeightForWidth())
        self.pushButton_add_tool_candidate.setSizePolicy(sizePolicy)
        self.pushButton_add_tool_candidate.setMinimumSize(QtCore.QSize(26, 26))
        self.pushButton_add_tool_candidate.setMaximumSize(QtCore.QSize(26, 26))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/add_tool.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_add_tool_candidate.setIcon(icon)
        self.pushButton_add_tool_candidate.setIconSize(QtCore.QSize(22, 22))
        self.pushButton_add_tool_candidate.setObjectName("pushButton_add_tool_candidate")
        self.horizontalLayout.addWidget(self.pushButton_add_tool_candidate)
        self.pushButton_remove_tool_candidate = QtWidgets.QPushButton(self.tab_tools)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_remove_tool_candidate.sizePolicy().hasHeightForWidth())
        self.pushButton_remove_tool_candidate.setSizePolicy(sizePolicy)
        self.pushButton_remove_tool_candidate.setMinimumSize(QtCore.QSize(26, 26))
        self.pushButton_remove_tool_candidate.setMaximumSize(QtCore.QSize(26, 26))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/remove_tool.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_remove_tool_candidate.setIcon(icon1)
        self.pushButton_remove_tool_candidate.setIconSize(QtCore.QSize(22, 22))
        self.pushButton_remove_tool_candidate.setObjectName("pushButton_remove_tool_candidate")
        self.horizontalLayout.addWidget(self.pushButton_remove_tool_candidate)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.listView_tools.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Tool candidates</p></body></html>", None, -1))
        self.pushButton_add_tool_candidate.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Add Tool candidate to project</p></body></html>", None, -1))
        self.pushButton_remove_tool_candidate.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Remove Tool candidate from project</p></body></html>", None, -1))
