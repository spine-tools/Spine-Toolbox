...
"color: rgb(255, 255, 255);")
        ...
        MainWindow.setTabOrder(self.pushButton_ds_graph_view, self.pushButton_ds_open_directory)
        MainWindow.setTabOrder(self.pushButton_ds_open_directory, self.treeView_dc_references)
