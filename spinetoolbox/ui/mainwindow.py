...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 336, 361))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 336, 361))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 336, 361))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 336, 361))
        ...
        self.pushButton_open_network_map = QtWidgets.QPushButton(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_open_network_map.setMinimumSize(QtCore.QSize(75, 23))
        self.pushButton_open_network_map.setMaximumSize(QtCore.QSize(75, 23))
        ...
        self.verticalLayout_15.setContentsMargins(-1, 6, 6, 6)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 333, 361))
        self.scrollAreaWidgetContents_5.setObjectName("scrollAreaWidgetContents_5")
        self.verticalLayout_21 = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents_5)
        self.verticalLayout_21.setObjectName("verticalLayout_21")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.lineEdit_mapping_script_path = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_5)
        self.lineEdit_mapping_script_path.setText("")
        self.lineEdit_mapping_script_path.setClearButtonEnabled(True)
        self.lineEdit_mapping_script_path.setObjectName("lineEdit_mapping_script_path")
        self.horizontalLayout_4.addWidget(self.lineEdit_mapping_script_path)
        self.toolButton_select_mapping_script = QtWidgets.QToolButton(self.scrollAreaWidgetContents_5)
        self.toolButton_select_mapping_script.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.toolButton_select_mapping_script.sizePolicy().hasHeightForWidth())
        self.toolButton_select_mapping_script.setSizePolicy(sizePolicy)
        self.toolButton_select_mapping_script.setMinimumSize(QtCore.QSize(22, 22))
        self.toolButton_select_mapping_script.setMaximumSize(QtCore.QSize(22, 22))
        self.toolButton_select_mapping_script.setIcon(icon)
        self.toolButton_select_mapping_script.setObjectName("toolButton_select_mapping_script")
        self.horizontalLayout_4.addWidget(self.toolButton_select_mapping_script)
        self.verticalLayout_21.addLayout(self.horizontalLayout_4)
        self.pushButton_mapping_editor = QtWidgets.QPushButton(self.scrollAreaWidgetContents_5)
        self.pushButton_mapping_editor.setObjectName("pushButton_mapping_editor")
        self.verticalLayout_21.addWidget(self.pushButton_mapping_editor)
        ...
        MainWindow.setTabOrder(self.treeView_view, self.pushButton_open_network_map)
        MainWindow.setTabOrder(self.pushButton_open_network_map, self.toolButton_view_open_dir)
        ...
        MainWindow.setTabOrder(self.scrollArea_6, self.lineEdit_mapping_script_path)
        MainWindow.setTabOrder(self.lineEdit_mapping_script_path, self.toolButton_select_mapping_script)
        MainWindow.setTabOrder(self.toolButton_select_mapping_script, self.pushButton_mapping_editor)
        MainWindow.setTabOrder(self.pushButton_mapping_editor, self.toolButton_di_open_dir)
        MainWindow.setTabOrder(self.toolButton_di_open_dir, self.tabWidget_item_properties)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_open_network_map.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Open Graph view for selected db reference (read-only)</p></body></html>", None, -1))
        ...
        self.lineEdit_mapping_script_path.setPlaceholderText(QtWidgets.QApplication.translate("MainWindow", "Path to mapping script", None, -1))
        self.toolButton_select_mapping_script.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Open SQLite file.</p></body></html>", None, -1))
        self.pushButton_mapping_editor.setText(QtWidgets.QApplication.translate("MainWindow", "Mapping Editor", None, -1))
