...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolButton_add_tool_candidate = QtWidgets.QToolButton(self.tab_tools)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/add_tool.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButton_add_tool_candidate.setIcon(icon)
        self.toolButton_add_tool_candidate.setIconSize(QtCore.QSize(20, 20))
        self.toolButton_add_tool_candidate.setAutoRaise(False)
        self.toolButton_add_tool_candidate.setObjectName("toolButton_add_tool_candidate")
        self.horizontalLayout.addWidget(self.toolButton_add_tool_candidate)
        self.toolButton_remove_tool_candidate = QtWidgets.QToolButton(self.tab_tools)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/remove_tool.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButton_remove_tool_candidate.setIcon(icon1)
        self.toolButton_remove_tool_candidate.setIconSize(QtCore.QSize(20, 20))
        self.toolButton_remove_tool_candidate.setObjectName("toolButton_remove_tool_candidate")
        self.horizontalLayout.addWidget(self.toolButton_remove_tool_candidate)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.listView_tools.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Tools available in this project</p></body></html>", None, -1))
        self.toolButton_add_tool_candidate.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Add Tool to project</p></body></html>", None, -1))
        self.toolButton_remove_tool_candidate.setToolTip(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Remove Tool from project</p></body></html>", None, -1))
