...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockWidget_items = QDockWidget(MainWindow)
        self.dockWidget_items.setObjectName(u"dockWidget_items")
        ...
        self.treeView_items = QTreeView(self.dockWidgetContents_2)
        self.treeView_items.setObjectName(u"treeView_items")
        self.treeView_items.setFocusPolicy(Qt.FocusPolicy.NoFocus)

        self.verticalLayout_3.addWidget(self.treeView_items)

        self.dockWidget_items.setWidget(self.dockWidgetContents_2)
        MainWindow.addDockWidget(Qt.DockWidgetArea.LeftDockWidgetArea, self.dockWidget_items)
