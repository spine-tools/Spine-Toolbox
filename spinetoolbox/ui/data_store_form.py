...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_4.addWidget(self.toolButton_remove_object_parameters)
        ...
        self.horizontalLayout_5.addWidget(self.toolButton_remove_relationship_parameters)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/plus_object_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_object_classes.setIcon(icon2)
        self.actionAdd_object_classes.setObjectName("actionAdd_object_classes")
        self.actionAdd_objects = QtWidgets.QAction(MainWindow)
        self.actionAdd_objects.setIcon(icon2)
        self.actionAdd_objects.setObjectName("actionAdd_objects")
        self.actionAdd_relationship_classes = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/plus_relationship_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_relationship_classes.setIcon(icon3)
        ...
        self.actionAdd_relationships.setIcon(icon3)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/plus_object_parameter_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_object_parameters.setIcon(icon5)
        ...
        self.actionAdd_object_parameter_values.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/minus_object_parameter_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_object_parameter_values.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/plus_relationship_parameter_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_relationship_parameters.setIcon(icon7)
        ...
        self.actionAdd_relationship_parameter_values.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/minus_relationship_parameter_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_relationship_parameter_values.setIcon(icon8)
        ...
        self.actionRemove_object_parameters.setIcon(icon6)
        ...
        self.actionRemove_relationship_parameters.setIcon(icon8)
