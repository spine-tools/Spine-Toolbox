...
class ProjectItemSpecificationFactory:
    ...
    def make_specification(definition, app_settings, logger, embedded_julia_console=None, embedded_python_console=None):
        ...
        Args:
            ...
            embedded_julia_console (JuliaConsoleWidget, optional): a console widget for specifications that need one
            embedded_python_console (PythonConsoleWidget, optional): a console widget for specifications that need one
