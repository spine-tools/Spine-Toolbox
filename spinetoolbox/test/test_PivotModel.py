...
import unittest
from mvcmodels.tabularview_models import PivotModel
...
class TestPivotModel(unittest.TestCase):
    def setUp(self):
        ...
        self.tuple_index_entries = {('test1', 'test2'): set([('f', 'ee'), ('a', 'cc')]), ('test3',): set([(6,)])}
    ...
    def test_set_data3(self):
        ...
        model.set_new_data(
            ...
            self.index_types,
            rows=(),
            columns=tuple(self.index_names),
            tuple_index_entries=self.tuple_index_entries,
        )
        self.assertEqual(model._data, self.dict_data)
        self.assertEqual(model.index_names, tuple(self.index_names))
    ...
    def test_index_entries_without_data1(self):
        ...
        model = PivotModel()
        row_headers = set([('a', 'aa', 1), ('a', 'bb', 2), ('e', 'ee', 3)])
        new_keys, new_none_keys, new_entries = model._index_entries_without_data(
            ('test1', 'test2', 'test3'), row_headers, (), (), self.tuple_index_entries
        )
    ...
    def test_index_entries_without_data2(self):
        ...
        model = PivotModel()
        row_headers = set([('aa', 1), ('bb', 2)])
        new_keys, new_none_keys, new_entries = model._index_entries_without_data(
            ('test2', 'test3'), row_headers, ('test1',), ('a',), self.tuple_index_entries
        )
        self.assertEqual(new_keys, set())
    ...
    def test_index_entries_without_data3(self):
        ...
        row_headers = set([(1,), (2,)])
        new_keys, new_none_keys, new_entries = model._index_entries_without_data(
            ('test3',), row_headers, ('test1',), ('a',), self.tuple_index_entries
        )
    ...
    def test_index_entries_without_data4(self):
        ...
        model = PivotModel()
        row_headers = set([('a', 'cc'), ('f', 'ee'), ('a', 'aa')])
        new_keys, new_none_keys, new_entries = model._index_entries_without_data(
            ('test1', 'test2'), row_headers, (), (), self.tuple_index_entries
        )
        self.assertEqual(new_keys, set())
        self.assertEqual(new_none_keys, set())
    ...
    def test_set_pivoted_data1(self):
        ...
        model = PivotModel()
        model.set_new_data(self.data, self.index_names, self.index_types, tuple_index_entries=self.tuple_index_entries)
        data = [['row0_c0', 'row0_c1'], ['row2_c0', 'row2_c1']]
        row_mask = [0, 2]
        col_mask = [0, 1]
        new_data = {('a', 'aa', 1): 'row0_c0', ('b', 'cc', 3): 'row2_c0'}
        edit_data = {('a', 'aa', 1): 'value_a_aa_1', ('b', 'cc', 3): 'value_b_cc_3'}
    ...
    def test_set_pivoted_data2(self):
        ...
        model = PivotModel()
        model.set_new_data(self.data, self.index_names, self.index_types, tuple_index_entries=self.tuple_index_entries)
        data = [['row0_c0', 'row0_c1'], ['row8_c0', 'row8_c1']]
        row_mask = [0, 8]
        col_mask = [0, 1]
    ...
    def test_set_pivoted_data3(self):
        ...
        edit_data = {('a', 'aa', 1): 'value_a_aa_1', ('a', 'aa', 2): None, ('b', 'cc', 1): None, ('b', 'cc', 2): None}
        model.set_pivoted_data(data, row_mask, col_mask)
        self.assertEqual(model._data, {**self.dict_data, **new_data})
        self.assertEqual(model._edit_data, edit_data)
        self.assertEqual(model._deleted_data, {})
    ...
    def test_get_pivoted_data1(self):
        ...
        model.set_pivot(['test2'], ['test3'], ['test1'], ('a',))
        data = [
            ['value_a_aa_1', None, None, None, None, None],
    ...
    def test_get_unique_index_values1(self):
        ...
        model = PivotModel()
        model.set_new_data(self.data, self.index_names, self.index_types)
        index_set = set([('a', 'aa'), ('a', 'bb'), ('b', 'cc'), ('c', 'cc'), ('d', 'dd'), ('e', 'ee')])
    ...
    def test_is_valid_index3(self):
        ...
        model.set_new_data(
            ...
            self.index_names,
            self.index_types,
            valid_index_values={'test1': set(['correct_value']), 'test3': range(10)},
        )
    ...
    def test_is_valid_key1(self):
        ...
        self.assertTrue(
            model.is_valid_key(('valid1', 'valid2', 4), model._row_data_header_set, ('test1', 'test2', 'test3'))
        )
    ...
    def test_is_valid_key2(self):
        ...
        model = PivotModel()
        model.set_new_data(self.data, self.index_names, self.index_types)
        self.assertFalse(model.is_valid_key(('a', 'aa', 1), model._row_data_header_set, ('test1', 'test2', 'test3')))
    ...
    def test_is_valid_key3(self):
        ...
        model.set_new_data(self.data, self.index_names, self.index_types)
        self.assertFalse(
            model.is_valid_key(('a', 'aa', 'invalid_type'), model._row_data_header_set, ('test1', 'test2', 'test3'))
        )
    ...
    def test_delete_tuple_index_values5(self):
        ...
        model = PivotModel()
        model.set_new_data(self.data, self.index_names, self.index_types, tuple_index_entries=self.tuple_index_entries)
        expected_tuple_values = set(
            [('a', 'bb'), ('a', 'cc'), ('b', 'cc'), ('c', 'cc'), ('d', 'dd'), ('e', 'ee'), ('f', 'ee')]
        )
    ...
    def test_add_index_value3(self):
        ...
        model = PivotModel()
        model.set_new_data(
            self.data, self.index_names, self.index_types, used_index_values={('test1',): set(['used_value'])}
        )
    ...
    def test_delete_entries_with_wrong_index(self):
        ...
        model = PivotModel()
        model.set_new_data(
            self.data, self.index_names, self.index_types, used_index_values={('test1', 'test2'): set(['wrong_index'])}
        )
    ...
    def test_delete_index_values_with_same_name3(self):
        ...
        model.set_new_data(
            ...
            self.index_names,
            self.index_types,
            index_real_names=['test', 'test', 'test3'],
            tuple_index_entries={('test1', 'test2', 'test3'): set()},
        )
        model.delete_index_values({'test': set(['a'])})
    ...
    def test_delete_index_values_with_same_name4(self):
        ...
        model.set_new_data(
            ...
            self.index_types,
            index_real_names=['test', 'test', 'test3'],
            used_index_values={('test',): set(['a', 'b', 'c', 'd'])},
        )
        model.delete_index_values({'test': set(['a'])})
