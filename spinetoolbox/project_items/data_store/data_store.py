...
class DataStore(ProjectItem):
    ...
    def notify_destination(self, source_item):
        ...
        elif source_item.item_type() == "Recombinator":
            self._logger.msg.emit(
                f"Link established. Combined data generated by <b>{source_item.name}</b> will be "
                f"merged into <b>{self.name}'s upon execution</b>."
            )
