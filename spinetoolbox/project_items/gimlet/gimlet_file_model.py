...
"""
List model class for Gimlet properties.
...
from PySide2.QtCore import Signal, Qt, QAbstractListModel, QModelIndex, QFileInfo
from PySide2.QtWidgets import QFileIconProvider
from spinetoolbox.project_items.importer.importer import _FileListItem as FileListItem
...
class GimletFileModel(QAbstractListModel):
    """A model for Gimlet's file tree view."""

    selected_state_changed = Signal(bool, str)
    """Emitted when an item has been checked or unchecked."""
    ...
    def mark_as_nonexistent(self, index):
        """Marks item at index as non-existing."""
...
# class FileListItem:
#     """An item for GimletFileModel."""
#
#     def __init__(self, label, path, provider_name, is_pattern=False):
#         """
#
#         Args:
#             label (str): File label; full path for 'permanent' files or just the basename
#                 for 'transient' files like Tool's output.
#             path (str): Absolute file path, empty if not known
...
#
#         Returns:
#             FileListItem: Item based on given resource
#         """
#         is_pattern = False
#         if resource.type_ == "file":
#             label = resource.path
