...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_view_open_ds_view = QPushButton(self.scrollAreaWidgetContents_4)
        self.pushButton_view_open_ds_view.setObjectName(u"pushButton_view_open_ds_view")
        sizePolicy1 = QSizePolicy(QSizePolicy.MinimumExpanding, QSizePolicy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.pushButton_view_open_ds_view.sizePolicy().hasHeightForWidth())
        self.pushButton_view_open_ds_view.setSizePolicy(sizePolicy1)
        self.pushButton_view_open_ds_view.setMinimumSize(QSize(75, 23))
        self.pushButton_view_open_ds_view.setMaximumSize(QSize(16777215, 23))
...
#if QT_CONFIG(tooltip)
        self.pushButton_view_open_ds_view.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>Open Data store view for selected db references</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_view_open_ds_view.setText(QCoreApplication.translate("Form", u"Open view", None))
#if QT_CONFIG(tooltip)
