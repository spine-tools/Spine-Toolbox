...
copyright = '2018, Pekka Savolainen, Manuel Marin, Erkka Rinne'
author = 'Pekka Savolainen, Manuel Marin, Erkka Rinne'
...
source_parsers = {'.md': 'recommonmark.parser.CommonMarkParser'}  # Works but not with included .md files
