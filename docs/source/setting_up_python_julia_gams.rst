...
*********************************
Setting up Python, Julia and GAMS
*********************************
...
`<https://julialang.org/downloads/>`_.
...
3. Remember the path where you installed it (e.g. `C:\\Python38`)
4. Start Spine Toolbox
5. Go to File -> Settings (or press F1) and click the Tools tab open
6. Browse and select the Python interpreter that you just installed (e.g. `C:\\Python38\\python.exe`)
...
basic idea is the same as with Python . You can either execute Julia Tools in the embedded Julia Console
or as in the shell.
...
Executing an Exporter project item, requires an installation of GAMS.
