...
class TestTreeReloadClearsLevelFilters(DBEditorTestBase):
    def test_reload_clears_stale_entity_filter_and_entities_return(self):
        ...
        for editor in self.spine_db_editor._entity_tree_filter_bar.editors():
            assert editor.text() == ""

    def test_reload_clears_filters_and_bars_on_all_four_trees(self):
        ...
        bars = [
            editor._entity_tree_filter_bar,
            editor._alternative_tree_filter_bar,
            editor._scenario_tree_filter_bar,
            editor._value_list_tree_filter_bar,
        ]
