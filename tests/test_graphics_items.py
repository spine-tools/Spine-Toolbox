...
class TestProjectItemIcon(unittest.TestCase):
    ...
    def test_init(self):
        icon = ProjectItemIcon(self._toolbox, ":/icons/home.svg", QColor(Qt.gray), QColor(Qt.green))
    ...
    def test_outgoing_and_incoming_links(self):
        source_icon = ProjectItemIcon(self._toolbox, ":/icons/home.svg", QColor(Qt.gray), QColor(Qt.green))
        target_icon = ProjectItemIcon(self._toolbox, ":/icons/home.svg", QColor(Qt.gray), QColor(Qt.green))
...
class TestRankIcon(unittest.TestCase):
    ...
    def test_set_rank(self):
        item_icon = ProjectItemIcon(self._toolbox, ":/icons/home.svg", QColor(Qt.gray), QColor(Qt.green))
...
class TestLink(unittest.TestCase):
    ...
    def setUp(self):
        ...
        source_item_icon = ProjectItemIcon(self._toolbox, ":/icons/home.svg", QColor(Qt.gray), QColor(Qt.green))
        source_item_icon.update_name_item("source icon")
        destination_item_icon = ProjectItemIcon(self._toolbox, ":/icons/home.svg", QColor(Qt.gray), QColor(Qt.green))
