...
CALL append_license_xml ..\spinetoolbox\ui\add_connection_string.ui
CALL append_license_xml ..\spinetoolbox\ui\spine_data_explorer.ui
ECHO.
...
CALL append_license_py ..\spinetoolbox\ui\add_connection_string.py
CALL append_license_py ..\spinetoolbox\ui\spine_data_explorer.py
